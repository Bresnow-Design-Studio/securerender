//slight tweak of https://github.com/GianlucaGuarini/immutable-dom
 const config = {
    attributes: true,
    childList: true,
    subtree: true,
 ...
 */
export default function (node = document.documentElement, opts) {

    let configuration = opts.config || config
